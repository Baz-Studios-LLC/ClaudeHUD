...
test('settings survive a fresh instance including compact state and expanded dimensions', () => {
  ...
  const changes = { opacity: .85, sound: true, showThinking: true, shortcut: 'Alt+Shift+C', expanded: false, settingsOpen: true, windowMode: 'maximized', bounds: { x: -800, y: 60, width: 500, height: 700 } };
